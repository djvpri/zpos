    ...
    >
      ...
      <style>{`
        ...
        @media print {
          ...
          .ctk-small .ctk-harga { margin-bottom: calc(var(--ctk-h) * 0.07); }
          ...
          .ctk-small .ctk-svg { margin-top: calc(var(--ctk-h) * 0.07); margin-bottom: calc(var(--ctk-h) * 0.03); border-top: calc(var(--ctk-h) * 0.03) solid #999; padding-top: calc(var(--ctk-h) * 0.07); }
