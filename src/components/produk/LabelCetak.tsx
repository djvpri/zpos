    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      ...
      <style>{`
        ...
        @media print {
          ...
          .ctk-label { display: block; width: 100%; height: 30mm; padding: 1mm 2mm 0.5mm; box-sizing: border-box; text-align: center; font-family: system-ui, Arial, sans-serif; }
          .ctk-nama { font-size: 8px; font-weight: 700; color: #333; text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
          .ctk-harga { font-size: 14px; font-weight: 800; color: #000; text-align: center; }
          .ctk-svg { text-align: center; width: 100%; }
          /* Barcode tinggi-penuh: width:100% (modul pas, laser baca) + height besar
             (bar menjulur hampir penuh label). Browser-stretch vertikal — modul
             horizontal tak berubah, jadi tetap scannable. */
          .ctk-svg svg { width: 100%; height: 20mm; display: block; }
          .ctk-bc { text-align: center; font-size: 7px; color: #555; }
        }
      `}</style>
