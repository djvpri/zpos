    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-gray-900 text-lg">Zomet POS</span>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm text-gray-600 hover:text-gray-900 font-medium transition-colors">
              Masuk
            </Link>
            <Link href="/register" className="text-sm bg-indigo-600 text-white px-4 py-2 rounded-xl font-semibold hover:bg-indigo-700 transition-colors">
              Daftar Gratis
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-5 pt-20 pb-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/register" className="px-8 py-3.5 bg-indigo-600 text-white rounded-2xl font-semibold text-sm hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-200">
            Mulai Gratis 30 Hari
          </Link>
          <Link href="/login" className="px-8 py-3.5 bg-gray-100 text-gray-700 rounded-2xl font-semibold text-sm hover:bg-gray-200 transition-colors">
            Sudah punya akun? Masuk
          </Link>
        </div>

        {/* App preview */}
        <div className="mt-16 bg-gray-50 rounded-3xl border border-gray-100 p-4 max-w-4xl mx-auto shadow-xl shadow-gray-100">
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 bg-gray-50">
              <div className="w-3 h-3 rounded-full bg-red-300" />
              <div className="w-3 h-3 rounded-full bg-yellow-300" />
              <div className="w-3 h-3 rounded-full bg-green-300" />
              <div className="flex-1 bg-white rounded-lg text-xs text-gray-400 text-center py-1 mx-4">zpos.up.railway.app/app</div>
            </div>
            <div className="grid grid-cols-[56px_1fr_200px] h-48 sm:h-64">
              {/* Sidebar preview */}
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Fitur lengkap untuk mengelola toko dari mana saja</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-gray-100 hover:border-indigo-200 hover:shadow-sm transition-all">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Harga yang terjangkau</h2>
            <p className="text-gray-500">Mulai gratis, upgrade kapan saja</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {plans.map((plan, i) => (
              <div key={i} className={`rounded-2xl border-2 p-7 relative ${plan.color} ${i === 1 ? 'shadow-lg shadow-indigo-100' : ''}`}>
                {plan.badge && (
                ...
                <Link href="/register"
                  ...
                  {i === 0 ? 'Mulai Trial Gratis' : 'Pilih Pro'}
                </Link>
              </div>
            ))}
          </div>
      ...
      <section className="bg-indigo-600 py-16">
        <div className="max-w-2xl mx-auto px-5 text-center">
          ...
          <p className="text-indigo-200 mb-8">Daftar sekarang dan coba gratis 30 hari. Tidak perlu kartu kredit.</p>
          <Link href="/register" className="inline-block px-8 py-3.5 bg-white text-indigo-600 rounded-2xl font-bold text-sm hover:bg-indigo-50 transition-colors">
      ...
      <footer className="border-t border-gray-100 py-8">
        <div className="max-w-6xl mx-auto px-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-400">© 2026 Zomet POS. Dibuat dengan ❤️ untuk UMKM Indonesia.</p>
